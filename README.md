...
- `/menu` — стильное кнопочное меню с разделами: события, чеки, афиша, подписки, комьюнити и админ-панель.
...
- Кнопки главного меню открывают красивые карточки разделов с кратким описанием сценария и нужными командами.
...
- Карточка split-bill показывает визуальную шкалу оплат: ✅ оплатили / ⏳ ждём.
